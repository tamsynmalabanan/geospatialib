...
const isCompressedFile=(file)=>{const compressedExtensions=['zip','rar','7z','tar','gz']
...
const fetchFileData=async(params,{abortBtns,controller}={})=>{const handler=async(filesArray)=>{const file=filesArray.find(file=>file.name===params.name)
if(!file)return

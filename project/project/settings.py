...
SECURE_BROWSER_XSS_FILTER = not config('DEBUG', cast=bool)
SECURE_CONTENT_TYPE_NOSNIFF = not config('DEBUG', cast=bool)
SECURE_SSL_REDIRECT = not config('DEBUG', cast=bool)
SECURE_HSTS_SECONDS = 60*60*24*365
SECURE_HSTS_PRELOAD = not config('DEBUG', cast=bool)
SECURE_HSTS_INCLUDE_SUBDOMAINS = not config('DEBUG', cast=bool)

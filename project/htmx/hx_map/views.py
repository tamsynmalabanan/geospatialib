...
@login_required
def config_map(request, pk, section):
    ...
    return render(request, f'map/sidebar/{section}.html', context)
...
def map_privacy(request):
    ...
    return render(request, 'map/sidebar/footer/privacy.html', context)
